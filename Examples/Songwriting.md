# Example for Poetry / Songwriting

Same technique, applied to a creative/lyrical project.
...
#### 2. Outline Songs / Poems

List the songs/poems as a sequence, like chapters:

```
1. "Packing Light" - departure, anticipation
2. "Static" - disconnection, numbness
3. "Old Room" - nostalgia, grief
4. "Learning the Roads" - adaptation, small joys
5. "Still Here" - acceptance, peace
```

#### 3. Song/Poem Sentences

Summarize the emotional arc or central image of each piece in **one sentence**.

```
1. "Packing Light": Leaving feels lighter than expected, but something's missing.
2. "Static": The silence after leaving is louder than any noise.
3. "Old Room": Memory turns ordinary objects sacred.
4. "Learning the Roads": Small routines rebuild a sense of home.
5. "Still Here": Peace isn't the absence of loss, but living alongside it.
```

#### 4. Key Points / Images per Piece

For each song/poem, list 5–10 **images, phrases, or beats** you want to hit - not full lines yet, just anchors.

Beats for "Old Room":
```
1. "Old Room"
  1.1. Describe a specific object left behind (a chair, a poster)
  1.2. Contrast the room now vs. then
  1.3. A sound or smell that triggers memory
  1.4. A moment of almost going back
  1.5. Landing on acceptance without resolving fully
```
